...
class M_net(nn.Module):
    ...
    def __init__(self, classes=2):
        ...
        # ---------------------
        # 1/8
        self.de_conv_bn_relu_1 = n.Sequential(nn.Conv2d(128, 128, 3, 1, 1, bias=False),
                                       nn.BatchNorm2d(128),
                                       nn.ReLU())
        self.deconv_1 = nn.ConvTranspose2d(128, 128, 5, 2, 2, bias=False)

        # 1/4
        self.de_conv_bn_relu_2 = n.Sequential(nn.Conv2d(128, 64, 3, 1, 1, bias=False),
                                       nn.BatchNorm2d(64),
                                       nn.ReLU())
        self.deconv_2 = nn.ConvTranspose2d(64, 64, 5, 2, 2, bias=False)

        # 1/2
        self.de_conv_bn_relu_3 = n.Sequential(nn.Conv2d(64, 32, 3, 1, 1, bias=False),
                                       nn.BatchNorm2d(32),
                                       nn.ReLU())
        self.deconv_3 = nn.ConvTranspose2d(32, 32, 5, 2, 2, bias=False)

        # 1/1
        self.de_conv_bn_relu_4 = n.Sequential(nn.Conv2d(32, 16, 3, 1, 1, bias=False),
                                       nn.BatchNorm2d(16),
                                       nn.ReLU())
